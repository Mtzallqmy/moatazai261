...
import { ProviderError, type ProviderAdapterImplementation, type ProviderHealth, type ProviderModel, type StreamingResponse, type UnifiedChatResponse } from "./types";

export class NamedOpenAIAdapter extends OpenAICompatibleAdapter { constructor(readonly type:string){super();} }
export class BedrockAdapter implements ProviderAdapterImplementation{
